...
| GET, PUT         | `/api/settings`                    | Read settings; write `serverName`, `selfUpdate`, `updateCheckIntervalHours`, `maxConcurrentJobs`, `usageDelayThresholds`, `defaultWorkingDirectory` and `defaultWorktreeInclude`                                   |
