...
| GET, PUT         | `/api/settings`                    | Read settings; write `serverName`, `serverColor`, `selfUpdate`, `updateCheckIntervalHours`, `maxConcurrentJobs`, `usageDelayThresholds`, `defaultWorkingDirectory`, `defaultPrompt` and `defaultWorktreeInclude`                                   |
